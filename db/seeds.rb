Menu.create!([
  {
    name: 'Siciliana',
    description: 'supreme orange, shaved fennel, fresh mint, cracked pepper, evoo',
    category: 'salad',
    weight: 0
  },
  {
    name: 'Thai beef',
    description: 'mixed greens, ny strip, red onion, grilled pepper, cherry tomato,   spicy sesame-peanut dressing, parsley, mint',
    category: 'salad',
    weight: 1
  },
  {
    name: 'Kale',
    description: 'dried cranberry, chick pea, slivered almond, shaved manchego, cracked pepper, lemon vinaigrette',
    category: 'salad',
    weight: 2
  },
  {
    name: 'Papa potato salad',
    description: 'yukon gold potato, tomato, green bean, shaved onion, vinaigrette, fresh herbs',
    category: 'salad',
    weight: 3
  },
  {
  ...
  {
    name: 'Roasted caprese',
    description: 'frisée, fire-roasted cherry tomato, fresh mozzarella, fresh basil, evoo, flaky salt, grilled baguette, option to add prosciutto',
    category: 'salad',
    weight: 5
  }
])
